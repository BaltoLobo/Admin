...
<h3>Alta de aplicaciones</h3>
<form action="<?php echo base_url().'Aplicaciones/';?>" method="post" id="alta" name="alta" >
    <table class="Tformulario">
        ...
        <tr><td>&nbsp;</td><td colspan="2"><input type="button" value="Agregar" id="insertar" onclick="Formulario_aplicaciones_01('alta')"/></td></tr>
    </table>
